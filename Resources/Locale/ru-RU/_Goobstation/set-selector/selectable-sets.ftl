...
selectable-set-thief-anatomy-description =
    ...
    В комплект входят: Имплант-хранилище, имплант-Миксер ДНК, леденец
...
selectable-set-thief-breacher-description =
    ...
    В комплект входят: Два C4, мультитул, дистанционный сигнализатор, челюсти жизни, 
...
selectable-set-thief-chameleon-description =
    ...
    хамелеон-проектор и ID-карта агента.
...
selectable-set-thief-syndie-description =
    ...
    В комплект входят: Емаг, взломщик доступов, сигареты Interdyne, кодовое слово Синдиката,
...
selectable-set-thief-communicator-description =
    ...
    маска-хамелеон, а также 20 тысяч кредитов в кейсе.
...
selectable-set-syndicate-spy-description =
    ...
    удостоверение личности агента, пустой гипопен, радиоглушилка, стелс-коробка,
